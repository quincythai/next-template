...
- [Contributing to Sim Studio](#contributing-to-sim-studio)
  ...
  - [Local Development Setup](#local-development-setup)
    ...
    - [Option 2: Using VS Code / Cursor Dev Containers](#option-2-using-vs-code--cursor-dev-containers)
  ...
  - [Adding New Blocks and Tools](#adding-new-blocks-and-tools)
    - [Where to Add Your Code](#where-to-add-your-code)
    - [How to Create a New Block](#how-to-create-a-new-block)
